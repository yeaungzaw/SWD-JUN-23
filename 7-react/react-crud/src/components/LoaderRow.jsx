...
const LoaderRow = () => {
  return (
    <tr className="animate-pulse bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      >
        <div className="h-2.5 bg-gray-300 rounded-full dark:bg-gray-600 w-2" />
      </th>
      <td className="row-title cell-editable px-6 py-4">
      ...
      <td className="row-short cell-editable px-6 py-4">
        <div className="h-2.5 bg-gray-300 rounded-full dark:bg-gray-600 w-40" />
      </td>
      <td className="row-fee cell-editable px-6 py-4">
