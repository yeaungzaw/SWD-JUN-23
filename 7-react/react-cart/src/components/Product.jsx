...
const Product = ({
  ...
  const handleAddToCart = () => {
    ...
    // need to show already added sweet alert
  };
  ...
  return (
    <div className="product-card group">
      ...
      />
      {animate && (
        <AnimatedImage src={image} info={info} setAnimate={setAnimate} />
      )}
      <div className="product-card-body border border-neutral-600 p-5">
        ...
        <button
          ...
          } duration-100 active:scale-90 border border-neutral-600 block w-full h-12 font-heading disabled:pointer-events-none select-none`}
        >
