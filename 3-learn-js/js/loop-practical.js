...
// function separateEventOdd(inputArray) {
//     let evenArray = [];
...
// console.log(separateEventOdd(points));
...
// function arraySlice(inputArr, startIndex, length) {
//     const arr = [];
//     let arrIndex = 0;
...
//         arr[arrIndex++] = inputArr[i];
//     }

//     return arr;
// }

// function arraySlice(inputArr, index, length) {
//     const arr = [];
//     let arrIndex = 0;
...
// console.log(points);
// console.log(arraySlice(points, 3, 4));
...
// function reverseTriangle(rowCount) {
//     let rows = "";
...
function chess(rowCount, colCount) {
    let rows = "";
...
for (el of student1Mark) {
    ...
    // if (el.mark >= 40) {
    //     console.log(el.subject, "passed");
    // } else {
    //     console.log(el.subject, "failed");
    // }
    
    // console.log(el.subject, el.mark >= 40 ? "passed" : "failed");
    el.status = el.mark >= 40 ? "passed" : "failed";
}
