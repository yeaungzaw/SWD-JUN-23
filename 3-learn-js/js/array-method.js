...
products.sort((a, b) => {
  // - ထွက်ရင် ငယ်စဥ်ကြီးလိုက်
  // + ထွက်ရင် ကြီးစဥ်ငယ်လိုက်
  // 0 ထွက်ရင် နဂိုအတိုင်း
...
//   return {
//     title: el.title,
//     price: Number.parseFloat(el.price.toFixed(2)),
//     image: el.image
//   };
// })
...
// console.log(
//   products.every(el => el.price < 1500)
// );
...
// price < 50 ကုန်ပစ္စည်းတွေရဲ့ စုစုပေါင်းတန်ဖိုး
...
// fruits ထဲကစကားလုံး၅လုံးပါတာရှာမယ် အကြီးပြောင်းမယ် ပြီးတော့ and နဲ့ဆက်ပြီး စာသားအဖြစ်ပြမယ်
